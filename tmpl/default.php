...
<div class="jl-position-relative jl-visible-toggle" tabindex="-1" jl-slideshow="autoplay: true; animation: scale; max-height:580">
    ...
    <div class="jl-full-width-background" style="background-color:<?php echo $slides[0]->backgroundcolor; ?>"></div>
    <div class="jl-container">
        <div class="jl-slideshow-wrapper">
                        ...
                        <div class="jl-position-relative jl-visible-toggle" tabindex="-1" jl-slideshow="autoplay: true; animation: scale; max-height:580">
                            <div jl-grid>
                                <div class="jl-width-2-3">
                                    ...
                                    <a class="jl-button jl-button-default" href="<?php echo $slide->link_type; ?>"><?php echo $slide->button; ?></a>
                                </div>
